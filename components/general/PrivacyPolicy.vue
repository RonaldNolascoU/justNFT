<template>
  <div class="xl:container mx-3 lg:mx-5 py-5 xl:py-10">
    <p class="fs-24 text-bold text-primary">Privacy Policy</p>
    ...
    <br />
    <p class="fs-24 text-bold text-primary">Interpretation and Definitions</p>

    <p class="fs-20 text-bold text-navy">Interpretation</p>
    <p>
    ...
    <br />
    <p class="fs-20 text-bold text-navy">Definitions</p>
    ...
    <ul class="ml-5">
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Just Yours.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Just Yours, accessible from
          <a
            href="https://justyours.me/"
            rel="external nofollow noopener"
            target="_blank"
            >https://justyours.me/</a
          >
        </p>
      </li>
      <li>
    ...
    <p class="fs-24 text-bold text-primary">
      Collecting and Using Your Personal Data
    </p>
    <p class="fs-20 text-bold text-navy">Types of Data Collected</p>
    <p class="fs-20 text-bold text-navy">Personal Data</p>
    <p>
    ...
    <br />
    <p class="fs-20 text-bold text-navy">Usage Data</p>
    ...
    <br />
    <p class="fs-20 text-bold text-navy">Tracking Technologies and Cookies</p>
    <p>
    ...
    <br />
    <p class="fs-20 text-bold text-navy">Use of Your Personal Data</p>
    ...
    <br />
    <p class="fs-20 text-bold text-navy">Retention of Your Personal Data</p>
    <p>
    ...
    <br />
    <p class="fs-20 text-bold text-navy">Transfer of Your Personal Data</p>
    <p>
    ...
    <br />
    <p class="fs-20 text-bold text-navy">Disclosure of Your Personal Data</p>
    <p class="fs-20 text-bold text-navy">Business Transactions</p>
    <p>
    ...
    <br />
    <p class="fs-20 text-bold text-navy">Law enforcement</p>
    <p>
    ...
    <br />
    <p class="fs-20 text-bold text-navy">Security of Your Personal Data</p>
    <p>
    ...
    <br />
    <p class="fs-24 text-bold text-primary">Children's Privacy</p>
    <p>
    ...
    <br />
    <p class="fs-24 text-bold text-primary">Links to Other Websites</p>
    <p>
    ...
    <br />
    <p class="fs-24 text-bold text-primary">Changes to this Privacy Policy</p>
    <p>
    ...
    <br />
    <p class="fs-24 text-bold text-primary">Contact Us</p>
    <p>
